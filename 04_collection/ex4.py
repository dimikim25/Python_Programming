...
result = tuple(zip(subjects, scores, strict=True))
print(result)
...
result = tuple( i ** 2 for i in range(1, 11))       # tuple 안 인자가 1개일 경우 ()생략 가능
print(result)
...
result = tuple(sum(i) for i in zip(p1, p2))
print(result)
