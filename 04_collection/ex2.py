...
# [x] : x자체를 원소 하나로 하여 리스트에 삽입
print([zip(subjects, scores)])

# list[x] : x를 순회하여 리스트에 삽입
...
result = [i for i in words if i.find("n") + 1]
...
result = [sum(i)/len(i) for i in zip(scores[0], scores[1], scores[2])]
